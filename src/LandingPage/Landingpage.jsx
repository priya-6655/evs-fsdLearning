  ...
  return (
    <div className="container-fill ">
      <div className='root-img'>
        ...
        {/* select user type */}
        <div className="col-4 position-absolute border border-danger rounded py-5" style={{ top: "30%", left: "10%", padding: "20px", boxShadow: "20px 20px 20px rgba(0, 0, 0, 0.3)" }}>
          <p className="text text-decoration-underline text-center fs-4 fw-bold">
            Select User Type
          </p>
          <div className=" d-flex justify-content-center mt-3 p-5" >
            <select className="dropdown-menu show" onChange={handleNavigate} defaultValue="">
              <option value="" disabled>Select user type</option>
              <option className="dropdown-item" value="admin" >Admin</option>
              <option className="dropdown-item" value="electoral-officer">Electoral Officer</option>
              <option className="dropdown-item" value="UserOption">User</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className='col-12  mt-5 mb-5'>
        <div className='row d-flex justify-content-center gap-5'>
          ...
          <div className='col-3 d-flex justify-content-center p-3 flex-column align-items-center border border-dark' style={{ borderRadius: "20px", backgroundColor: "rgba(243, 19, 19, 0.6)" }}>
          ...
          <div className='col-3  d-flex justify-content-center p-3 flex-column align-items-center border border-dark' style={{ borderRadius: "20px" }}>
          ...
          <div className='col-3 d-flex justify-content-center p-3 flex-column align-items-center border border-dark' style={{ borderRadius: "20px", backgroundColor: "rgba(8, 96, 15, 0.6)" }}>
