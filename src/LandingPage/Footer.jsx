...
function Footer() {
    return (
        <div>
            <div className='container-fill' style={{ backgroundColor: "rgba(13, 11, 173, 0.6)" }}>
                <div className='row'>

                    <div className='col-12 col-md-6 col-lg-4 mt-3' style={{ backgroundColor: "rgba(28, 7, 76, 0.6)", borderRadius: "5px" }}>
                        ...
                        <div className='d-flex flex-column flex-md-row gap-3 p-3'>
                            <img src="https://www.ceodelhi.gov.in/img/de.png" alt='electLogo' style={{ width: "700px", height: "80px", marginTop: "20px", marginLeft: "20px" }} />
                            <p className='fs-6 text-light'>The Election Commission of India is an autonomous constitutional authority
                        ...
                        <p className='fs-6 text-light text-center mx-5' style={{ width: "350px" }}>
                    ...
                    <div className='col-12 col-md-6 col-lg-4 mt-3'>
                        ...
                        <div className='d-flex flex-row align-items-center'>
                            <p className='fs-5 text-light text-decoration-underline'>Quick Links</p>
                        ...
                        <div className='d-flex flex-column flex-sm-row gap-4 mt-3 itemLink'>
                            <ul style={{ listStyleType: "disc", paddingLeft: "20px", cursor: "pointer" }}>
                                <li>About ECI</li>
                                <li>Directory</li>
                                <li>Contact Us</li>
                    ...
                    <div className='col-12 col-sm-6 col-lg-2 mt-4 text-center prevElect'>
                        ...
                        <p className='fs-6 mt-2' style={{ cursor: "pointer" }}>Previous Election</p>
                    </div>

                    <div className='col-12 col-sm-6 col-lg-2 mt-3 text-center'>
                        <p className='fs-5 text-light text-decoration-underline text-center'>Social Media Link</p>
                        <div className='d-flex gap-3 justify-content-center mt-5' style={{ cursor: "pointer" }}>
