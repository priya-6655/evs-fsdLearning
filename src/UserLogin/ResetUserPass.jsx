        ...
        <div className='container-fill d-flex justify-content-center align-items-center' id='resetPassimg'>
            <form onSubmit={handleSubmit}>
                <div className='container' style={{ maxWidth: "500px", width: "100%" }}>
                    <p className="mb-5 text-success fw-bold fs-4 mx-5 text-center">Reset Your Password</p>
                    ...
                    <div className='d-flex flex-column align-items-center justify-content-center'>
                        ...
                        <button type='submit' className='btn btn-success w-25 mt-3 rounded-pill'>Reset</button>
                    </div>
                </div>
            </form>
        </div>
